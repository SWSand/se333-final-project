...
# Resolve repository root relative to this script and add to path so we can import server
...
def main():
    # workspace is the repository root; the Java project lives in `codebase/`
    ...
    if os.path.exists(jacoco_path):
        ...
        print("   Run: mvn -f codebase/pom.xml clean test jacoco:report (or run mvn inside codebase/)")
        return
