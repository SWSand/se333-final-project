...
## Phase 1: Setup and Baseline
 - [x] Configure JaCoCo in codebase/pom.xml
- [x] Create MCP tools in server.py
- [x] Document workflow and instructions
 - [x] Run initial `mvn -f codebase/pom.xml clean test jacoco:report`
...
- [x] Run `mvn -f codebase/pom.xml clean test jacoco:report`
